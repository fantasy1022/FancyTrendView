...
public class Injection {
    ...
    public static List<String> getMockHalfShapeTrendList() {
        return Arrays.asList(new String[]{"Apple Inc", "KKBOX", "Yahoo 新聞", "Laker", "Zenfone 3 room", "IBM"});
    }
    ...
    private static void generateCountryCodeMapping() {//May it can use SQLite
