...
public class GoogleTrendView extends RelativeLayout implements TypedTextView.OnBlinkCompleteListener {
    ...
    public GoogleTrendView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.GoogleTrendView);
            flipSpeed = a.getInteger(R.styleable.GoogleTrendView_flipSpeed, Constant.DEFALUT_FLIP_SPEED);
            flipDirectionType = a.getInteger(R.styleable.GoogleTrendView_flipDirection, Constant.DEFALUT_FLIP_DIRECTION_TYPE);
            groupChangeType = a.getInteger(R.styleable.GoogleTrendView_textChangeType, Constant.DEFALUT_CHANGE_TYPE);
            typedSpeed = a.getInteger(R.styleable.GoogleTrendView_typedSpeed, Constant.DEFALUT_TYPE_SPEED);
            cursorBlinkInterval = a.getInteger(R.styleable.GoogleTrendView_cursorBlinkInterval, Constant.DEFALUT_CURSOR_BLINK_INTERVAL);
            cursorWidth = a.getDimension(R.styleable.GoogleTrendView_cursorWidth, context.getResources().getDimension(R.dimen.cursorWidth));
            cursorBlinkTimesAfterTypeDone = a.getInteger(R.styleable.GoogleTrendView_cursorBlinkTimesAfterTypeDone, Constant.DEFALUT_CURSOR_BLINK_TIMES_AFTER_TYPED_DONE);
            textSize = a.getDimension(R.styleable.GoogleTrendView_textSize, context.getResources().getDimension(R.dimen.textSize));

            int colorsId = a.getResourceId(R.styleable.GoogleTrendView_colorArray, 0);
            if (colorsId != 0) {
            ...
            int textsId = a.getResourceId(R.styleable.GoogleTrendView_textArray, 0);
            if (textsId != 0) {
